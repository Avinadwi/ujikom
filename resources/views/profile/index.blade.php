            ...
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ url('/home') }}" class="btn btn-success text-white mt-2"><i class="fa fa-arrow-left"></i>
                        Kembali</a>
                    <a href="{{ url('cart') }}" class="btn btn-success text-white mt-2"><i class="fa fa-shopping-cart"></i>
                        Cart</a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="content-wrapper">
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <h5>Silahkan isi No HP dan alamat dengan Benar karena untuk kepentingan pengiriman pesanan.
                                    Terimakasih
                                </h5>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ url('profile') }}">
                                ...
                                <h4><i class="fa fa-pencil-alt"></i> Edit Password</h4>
                                <div class="formedit">
                                    <div class="form-group row">
                                        <label for="password"
                                            class="col-md-2 col-form-label text-md-right">{{ __('Password Baru') }}</label>
